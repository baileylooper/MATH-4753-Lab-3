...
$\frac{MSS}{TSS} = \frac{522.2756}{278.9475} = 1.8723$

The proportion of the total variability of the outcomes is accounted for by the model is 1.8723.

MSS + RSS = 562.317

and TSS = 522.2756

Thus, TSS is not equal to the sum of MSS and RSS, however it is close. 
